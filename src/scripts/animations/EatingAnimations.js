...
function teenOpenMouthAnimate(state) {
  if (state.tamaStage != tamaState[3] || !state.foodAnimationGoing) {
    return;
  }
...
function adultOneOpenMouthAnimate(state) {
  if (state.tamaStage != tamaState[7] || !state.foodAnimationGoing) {
    return;
  }
...
function adultThreeOpenMouthAnimate(state) {
  if (state.tamaStage != tamaState[9] || !state.foodAnimationGoing) {
    return;
  }
